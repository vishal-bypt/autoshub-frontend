...
import { setCurrentUserRole, Role, hasExecView, hasAdminView, hasManagerView, hasUserView } from "../../helpers";
    ...
    return (
      <Col xl="3" sm="6">
        <Card className="text-center">
          <img src={tileImage} alt={tileRole} onClick={() => {
