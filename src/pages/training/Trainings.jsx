                        ...
                        <table className="table">
                            ...
                            {users && users.map((user, index) =>
                                <tr key={user.id}>                                     
                                    ...
                                    <td className="traning-listing" style={{ minWidth: '200px' }}>{user.assignedToName ? user.assignedToName :"NA"}</td> 
                                    <td className="traning-listing" style={{ minWidth: '200px' }}>{user.assignedByName ? user.assignedByName :"NA"}</td>
