...
function Trainings({ match }) {
    ...
    return (
        ...
        //             <h1 className="text-center mb-5">All Training</h1>  
        //         </div>
        //         <div className="col-1">
        ...
        //     <Link to={`${path}/getAllByRole`} className="btn btn-primary btn-lg mb-2 mr-3">My Trainings</Link>
        //     <Link to={`${path}/getAll`} className="btn btn-info btn-lg mb-2 mr-3">View All</Link>
        //     </div>} */}
        ...
        //     {/* <th>Status</th> 
        //     <th>View Prequisites</th> 
        //     <th>Active / Decline Prequisites</th>      */}                    
        // </tr>
        //         </thead>
        //         <tbody>
        ...
        //         <td style={{ minWidth: '200px' }}>View Prequisites</td>
        //         <td style={{ minWidth: '200px' }}>Accept / Decline</td> */}
                ...
                <div className="row">
                    <div className="container">
                        <div className="col-md-12">
                            <h1 className="header-text">All Trainings</h1>

                            {/* <a onClick={()=>{history.push('.');}}  href="javascript:void" className="newbutton ">Back</a> */}
                            {/* <a onClick={()=>{history.push('/training/editList');}}  href="javascript:void" className="newbutton">Edit Trainings</a>
                    <a onClick={()=>{history.push('/training/getAllByRole');}}  href="javascript:void" className="newbutton">My Trainings</a>
                    <a onClick={()=>{history.push('/training/getAll');}}  href="javascript:void" className="newbutton">View All</a> */}
