...
function EditTraining({ history, match }) {
  ...
  const validationSchema = Yup.object().shape({
    ...
    trainingType: Yup.string().required("Training Type Name is required"),
    trainingStartDate: Yup.string().required("Training Start Date is required"),
    trainingEndDate: Yup.string().required("Training End Date is required"),
                  ...
                  <>
                    <div className="row mt-5">
                      ...
                      <div className="form-group col-md-6">
                        ...
                        <Field
                          ...
                          className={
                            "form-control" +
                            (errors.trainingType && touched.trainingType
                              ? " is-invalid"
                              : "")
                          }
                        />
                    ...
                    <div className="row">
                      ...
                      <div className="form-group col-6">
                        ...
                        <Field
                          ...
                          className={
                            "form-control" +
                            (errors.trainingEndDate && touched.trainingEndDate
                              ? " is-invalid"
                              : "")
                          }
                        />
                    ...
                    <div className="row">
                      <div className="form-group col-6">
                        ...
                        <Field
                          name="trainingPrequisites"
                          type="text"
                          className={
                            "form-control" +
                            (errors.trainingPrequisites &&
                            touched.trainingPrequisites
                              ? " is-invalid"
                              : "")
                          }
                        />
