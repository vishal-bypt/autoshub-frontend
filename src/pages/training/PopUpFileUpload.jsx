...
export default function PopUpFileUpload({ id,userDetails }) {
    ...
    return (
        <React.Fragment>
            <Button variant="outlined" className="uploadBtnPopUp" color="primary" onClick={handleClickOpen}>
                Upload
            </Button>
            <Dialog
                fullWidth={fullWidth}
            ...
            >
                <DialogTitle id="max-width-dialog-title">Document Upload
                    <hr></hr>
                </DialogTitle>
                <DialogContent>
                    <DialogContentText>
                    ...
                    {fileNameDisplay && <DialogContentText>
                        ...
                        <FormControl className={classes.formControl}>
                            ...
                            <div className="containerPopUpFileUpload">
                                ...
                                <div className="variantsPopUpFileUpload">
                                    {selectFileBtn && <IconButton onClick={() => {
                                    ...
                                    {uploadingBtn && <IconButton ><div className='filePopUpFileUpload file--uploadingPopUpFileUpload'>
                                    ...
                                    {successBtn && <IconButton ><div className='filePopUpFileUpload file--successPopUpFileUpload'>
                                        <label htmlFor='input-file'>
                                    ...
                                    {errorBtn && <IconButton ><div className='filePopUpFileUpload file--dangerPopUpFileUpload'>
                                        <label htmlFor='input-file'>
                                            <CloudOffIcon />Error
                                        </label>
                                        {/* <input id='input-file' type='file' /> */}
